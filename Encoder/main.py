...
if __name__ == '__main__':
    while True:
        ...
        if choice == '1':
            password = getpass("Nhập mật khẩu để MÃ HÓA (Lưu ý mật khẩu nhập vào sẽ bị che để đảm bảo bảo mật): ")
            ...
            password = getpass("Nhập mật khẩu để GIẢI MÃ (Lưu ý mật khẩu nhập vào sẽ bị che để đảm bảo bảo mật): ")
